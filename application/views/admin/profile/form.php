...
<div class="form-group">
    <label for="Title" class="col-md-4 control-label">4 digit code</label>
    <div class="col-md-8">
        <input type="text" name="digit_code"
            value="<?php echo ($this->input->post('digit_code') ? $this->input->post('digit_code') : $users['digit_code']); ?>"
            class="form-control" id="digit_code" min="4" max="4" required/>
    </div>
</div>
<div class="form-group">
